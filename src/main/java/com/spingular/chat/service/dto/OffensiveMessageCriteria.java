...
/**
 * Criteria class for the {@link com.spingular.chat.domain.OffensiveMessage} entity. This class is used
 * in {@link com.spingular.chat.web.rest.OffensiveMessageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /offensive-messages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class OffensiveMessageCriteria implements Serializable, Criteria {
    ...
    public OffensiveMessageCriteria(){
    }

    public OffensiveMessageCriteria(OffensiveMessageCriteria other){
    ...
    @Override
    public OffensiveMessageCriteria copy() {
        return new OffensiveMessageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final OffensiveMessageCriteria that = (OffensiveMessageCriteria) o;
        return
    ...
    public String toString() {
        return "OffensiveMessageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
